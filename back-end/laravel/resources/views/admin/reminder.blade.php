...
<body>
    ...
    $reminders = DB::table('reminders')->select('*')->get();
    $result = json_decode($reminders, true);
    $count=0;
    ?>
        ...
        <div class="modal fade" role="dialog" id="myModal">
          ...
          <div class="modal-content">
            ...
            <section class="clean-block clean-form dark">
                ...
                <form action="/admin/add/reminder" method="POST">
                    @csrf
                    <div class="form-group ">
                        <label for="id" class=" col-form-label">Upload By</label>
                      
                        <input type="text" class="form-control" name="id" id="id" placeholder="Upload By">
                    </div>
                      <div class="form-group ">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" name="case_no" id="case_no" placeholder="Case Number">
                        </div>
                        <div class="form-group ">
        ...
        <div id="content" style="margin-top:100px">
            <div class="container">
              <div class="card-header py-3" style="background-color:#D0D3D4 ">
                <p class="text-primary m-0 font-weight-bold">Reminders <span style="margin-bottom:5px;padding:0;justify-content:center" class="float-right"><button class="btn btn-primary"style="margin:0;padding:0"data-toggle="modal" data-target="#myModal"><a style="margin:0;padding:0 20px 0 20px" class="btn btn-primary" type="button">Add</a></button></span></p>
            </div>
                  ...
                  <table class="table dataTable my-0" id="dataTable">
                      ...
                      <tbody> 
                        ...
                        <tr>
                          ...
                          <td>{{$info['type']}}</td>
                          <td>{{$info['remind_date']}}</td>
                          <td>{!! Form::open(['action'=>['PagesController@deleteReminder',$info['id']],'method'=>'POST','class'=>'pull-right']) !!}
