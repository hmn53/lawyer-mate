                      ...
                      <div class="items" >
                            @if (strcmp($userType,"lawyer")==0)
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="col-md-5 product-info" style="margin-left:30px"><a class="product-name" target="_blank" href="/view/{{$i['path']}}">{{$i['document_name']}}</a>
                                        @endif
                                        @if (strcmp($i['verified'],"verified")==0)
                                        <div class="col-md-5 product-info" style="margin-left:30px"><a class="product-name" target="_blank" style="color:green"href="/view/{{$i['path']}}">{{$i['document_name']}}</a>
                                        @endif
                                        @if (strcmp($i['verified'],"rejected")==0)
                                        <div class="col-md-5 product-info" style="margin-left:30px"><a class="product-name" target="_blank"  style="color:red"href="/view/{{$i['path']}}">{{$i['document_name']}}</a>
                                        @endif
                                ...
                                <div class="product">
                                    <div class="row justify-content-center align-items-center">
                                        ...
                                        <div class="col-md-5 product-info" style="margin-left:30px"><a class="product-name" href="/view/{{$item['path']}}" target="_blank" >{{$item['document_name']}}</a>
                                            <div class="product-specs" style="font-size:0.85em;">
